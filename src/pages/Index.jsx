...
const Index = () => {
  ...
  return (
    <div className="min-h-screen p-8 bg-red-900 text-red-100">
      <h1 className="text-4xl font-bold mb-8 text-center text-red-50">Top 100 Hacker News Stories</h1>
      <div className="mb-6">
        <Input
          type="text"
        ...
        <div className="space-y-4">
          {filteredStories.map((story) => (
            <div key={story.objectID} className="bg-red-800 p-4 rounded shadow">
              <h2 className="text-xl font-semibold mb-2 text-red-100">{story.title}</h2>
